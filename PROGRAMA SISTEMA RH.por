programa
{
 ...
 Inicio()
	...
	função seletor_programa(inteiro opção)
	{
	...
	funcao real calculo_ferias(real salario, real venda_ferias)
{
	...
	funcao simulador_seguro_desemprego()
	{
		...
		escreva("\n")
		escreva("\n")
		escreva(" \n INFORME QUANTAS VEZES JÁ SOLICITOU O BENEFÍCIO?: ")
 ...
 * @DOBRAMENTO-CODIGO = [13, 28, 94, 117, 127, 136, 148, 156, 171, 204, 236, 264, 334, 341, 358, 376, 380, 398, 446, 479, 455, 535, 554, 562, 588, 622, 679, 713, 733, 755, 771];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {salario, 128, 42, 7}-{desconto_vale_transporte, 130, 7, 24}-{salario, 591, 7, 7}-{desconto_vale_transporte, 591, 16, 24};
 * @FILTRO-ARVORE-TIPOS-DE-DADO = inteiro, real, lógico, cadeia, caracter, vazio;
 * @FILTRO-ARVORE-TIPOS-DE-SIMBOLO = variável, vetor, matriz, função;
 */
/* $$$ Portugol Studio $$$ 
 * 
 * Esta seção do arquivo guarda informações do Portugol Studio.
