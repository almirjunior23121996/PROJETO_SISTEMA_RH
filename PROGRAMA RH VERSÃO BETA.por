	...
	funcao real calculo_ferias(real salario, real venda_ferias)
{
	...
	{	
		...
		numero_telefone = ("NUMERO DE TELEFONE : " + numero_telefone)
		...
		resultado_cep = TXT.substituir(resultado_cep, "{" , "ENDEREÇO: ")
		resultado_cep = TXT.substituir(resultado_cep, "\"" ,"" )
 ...
 * Você pode apagá-la se estiver utilizando outro editor.
 * 
 * @POSICAO-CURSOR = 11673; 
 * @DOBRAMENTO-CODIGO = [13, 28, 94, 117, 127, 136, 148, 156, 171, 204, 236, 264, 334, 341, 358, 376, 380, 450, 459, 539, 558, 566, 592, 626, 683, 717, 737, 759, 775];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = ;
 * @FILTRO-ARVORE-TIPOS-DE-DADO = inteiro, real, logico, cadeia, caracter, vazio;
 * @FILTRO-ARVORE-TIPOS-DE-SIMBOLO = variavel, vetor, matriz, funcao;
